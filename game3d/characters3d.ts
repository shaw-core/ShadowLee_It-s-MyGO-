...
export const SKINS: SkinMeta[] = [
  { id: 'skin1', name: '1号 · 睡衣眼罩', vibe: '软萌 · 安静 · 治愈', features: ['猫耳睡帽 + 银白短发', '眼罩遮右眼', '蓝白睡衣风', '怀里抱着熊猫玩偶', '能力「安心毛绒」：眩晕增长减半，薄荷糖效果更强'] },
  { id: 'skin2', name: '2号 · 显示器头', vibe: 'AI · 机器人 · 电子吉祥物', features: ['身体与1号相同', '头部是一块显示器', '屏幕上是睡眼猫嘴表情', '顶部机械耳', '能力「高速处理」：次元切换冷却减半'] },
  { id: 'skin3', name: '3号 · 熊猫外套', vibe: '活泼 · 外向 · 冒险感', features: ['及腰长白发', '宽大蓝色外套', '熊猫耳 + 护目镜', '白色连衣裙', '能力「冒险家」：可以二段跳！'] },
  { id: 'skin4', name: '4号 · 独眼露目', vibe: '安静 · 病弱 · 神秘', features: ['银白短发双侧扎', '单眼眼罩 + 熊猫耳', '白蓝色居家服', '腿上贴着创可贴', '能力「创可贴」：每个存档点区间可抵挡一次尖刺'] },
